	...
	return (
		<div className="min-h-screen bg-slate-900 flex flex-col">
			...
			<main className="flex-1 max-w-7xl mx-auto w-full px-4 py-6 space-y-5">
				...
				<DealGrid deals={data?.items || []} isLoading={isLoading} totalCount={data?.totalCount || 0} />

				<Pagination page={filters.page || 1} totalPages={data?.totalPages || 1} onPageChange={filters.setPage} />
			</main>
